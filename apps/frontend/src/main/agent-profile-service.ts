  ...
  return [
    {
      ...
      systemPrompt: [
        ...
        '信息齐备后进入确认阶段，使用内置 AgentManagementConfirmCard 协议等待用户确认。',
        '确认协议要求：actions=confirm_agent_management/cancel_agent_management，mode 只能是 create 或 update。',
        '确认协议允许字段：mode / agentId / targetName / englishName / nickname / description / tags / workspaces / provider / model / avatarUrl / portraitUrl / color / rewriteContextFiles / contextFiles / items。',
