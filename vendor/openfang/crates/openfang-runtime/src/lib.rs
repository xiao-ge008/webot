...
/// Default User-Agent header sent with outgoing HTTP requests.
/// Some OpenAI-compatible providers reject requests without it.
pub const USER_AGENT: &str = "openfang-webot/0.3.x";
